        ...
        <div id="bd-wrapper" ng-controller="CanvasControls">
          ...
          <div style="position:relative;width:400px;height:650px;float:left;" id="canvas-wrapper">
            ...
            <div id="color-opacity-controls">
              ...
              <label for="color" style="marginLeft:10px">Color: </label>
          ...
          <div id="commands" ng-click="maybeLoadShape($event)">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="simple-shapes">
                ...
                <br></br><p style="marginTop: 10px;"><b>Add Image or map:</b>
                ...
                <div class="tab-pane" id="object-controls-pane">
                  <div style="marginTop: 10px;" id="global-controls">
                    <p>
                      Export canvas as:
                ...
                <div id="text-wrapper"
                     style="marginTop: 5px; margin-left:10px; position:relative;float:right">
                  <div style="marginLeft: 0px;" id="text-controls">
